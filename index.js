...
*/
console.log('Task 1b:', createMenuItem('chicken salad', 10, 'Lunch'));
console.log('Task 1b:', createMenuItem('milkshake', 5, 'Drinks'));
console.log('Task 1b:', createMenuItem('chocolate cake', 6, 'Dessert'));
...
console.log('Task 5:', addReview(reviews, 'Gabriela', 5, 'Adorable restaurant! Perfect for a date!'));
